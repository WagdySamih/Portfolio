...
export const Projects: Project[] = [
  ...
  },
  {
    ...
    techs: ["TS", "Webpack"],
    githubLink: "https://github.com/WagdySamih/Project-Manager-Drag-Drop/",
    deploymentLink: "",
  },
  {
    title: "Financer",
...

  {
    title: "Chat App",
    description:
      "A real-time chat application that supports sending real-time messages  sending and locations  within different rooms.",
    techs: ["Express", "Socket.io", "JS"],
