...
const WEBSITE_DESCRIPTION =
  "Wagdy Samih is software engineer, Working mostly with JavaScript frameworks, Having four year of Experience as MERN | MEAN stack developer";

const WEBSITE_IMAGE = "images/demo.png";
const WEBSITE_KEYWORDS =
  "Wagdy, Wagdy Samih, Wagdy Samih Software engineer, JavaScript Developer, Full Stack developer, MEARN Stack developer, MERN Stack developer, Next.js developer";
